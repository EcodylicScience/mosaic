...
class InteractionCropPipeline:
    ...
    class Params(Params):
        ...
        center_offset_px: Annotated[
            float, Declared(CENTER_OFFSET_PX_DESCRIPTION, unit="px")
        ] = 0.0
        rotate_to_heading: Annotated[bool, Declared(ROTATE_TO_HEADING_DESCRIPTION)] = (
            True
        )
        heading_points: Annotated[
            tuple[int, int], Declared(HEADING_POINTS_DESCRIPTION)
        ] = (3, 6)
        margin_factor: Annotated[float, Declared(MARGIN_FACTOR_DESCRIPTION)] = 1.5
        angle_col: Annotated[str | None, Declared(ANGLE_COL_DESCRIPTION)] = None
        interpolation: Annotated[
            int,
            Field(examples=[0, 1, 2, 3, 4]),
            Declared(INTERPOLATION_FLAG_DESCRIPTION),
        ] = 1  # cv2.INTER_LINEAR
        background_color: Annotated[int, Declared(BACKGROUND_COLOR_DESCRIPTION)] = 0
        # Post-processing
        body_mask: Annotated[bool, Declared(BODY_MASK_DESCRIPTION)] = False
        body_mask_length_px: Annotated[
            int, Declared(BODY_MASK_LENGTH_PX_DESCRIPTION, unit="px")
        ] = 96
        body_mask_width_px: Annotated[
            int, Declared(BODY_MASK_WIDTH_PX_DESCRIPTION, unit="px")
        ] = 64
        use_clahe: Annotated[bool, Declared(USE_CLAHE_DESCRIPTION)] = False
        clahe_clip_limit: Annotated[float, Declared(CLAHE_CLIP_LIMIT_DESCRIPTION)] = 2.0
        clahe_tile_grid_size: Annotated[
            int, Declared(CLAHE_TILE_GRID_SIZE_DESCRIPTION)
        ] = 25
        grayscale: Annotated[bool, Declared(GRAYSCALE_DESCRIPTION)] = False
        ...
        output_fps: Annotated[
            float | None, Declared(OUTPUT_FPS_DESCRIPTION, unit="fps")
        ] = None
